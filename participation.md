...
The SRCCON schedule lives at [schedule.srccon.org](https://schedule.srccon.org), and will be updated for 2018 a couple weeks before SRCCON. If you load the schedule on your phone, you can even mark sessions you want to attend and build your own custom schedule. We'll also post session names outside each room during the conference.
