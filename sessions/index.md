...
**Important:** All SRCCON participants, including session leaders, need a ticket to the event. We sold out much sooner than we expected to, and although we are working on increasing capacity, we can't guarantee that if you submit a proposal, we can open a ticket for you. If you **do** have a ticket and haven't yet pitched a session, please consider doing so! 
