...
- Check out the #srccon channels on the [News Nerdery](https://newsnerdery.org/) or [Lonely Coders Club](https://lcc-slack.herokuapp.com/) Slacks. Team members are active in those channels, so they're a great place to post questions that may be of broad interest.
