...
## What is SRCCON
OpenNews has been hosting SRCCON annually since 2014, plus a series of smaller, topical conferences starting in 2017 with SRCCON:WORK and continuing with SRCCON:POWER in 2018. SRCCON is a conference where participants come first so they can focus on collaborating on the work at hand. Over this time SRCCON has:
...
- supported 193 participants and facilitators in attending the event with scholarships.
...
- led to countless job connections, innovative project and ideas and collaborations, and new organizational policies on hiring, inclusion, mentorship, workflow, development processes, and more.

## Who attends and why

People come first at SRCCON. The entire structure of the event is set up to allow participants to focus on getting to know each other and learn from the wisdom in the room.  A third of participants also facilitate sessions, leading conversations and skillshares, helping folks bring new ideas and experience back to their newsrooms. 

### The SRCCON 2018 audience included:

- 304 attendees from New York and DC, as well as Minneapolis, Chicago, San Francisco, Los Angeles, Louisville, Boston, Philadelphia, Austin, Knoxville, Spokane, Durham, Iowa Falls, numerous other cities throughout the U.S. and beyond.
...
- sessions included a [kickoff kit for new teams starting off](https://www.dropbox.com/s/i8nvfri3zh5jk8b/Kickoff%20Kit%20Packet.pdf?dl=0),  [a discussion of rebuilding ad tech](https://docs.google.com/presentation/d/1_6Kp6eMFEvB9nPHtzyJxOdiJPMxYn1KEFdyCWYBpK6o/edit#slide=id.gc6fa3c898_0_0), [a product design exercise for membership programs](https://building.theatlantic.com/designing-a-membership-program-in-75-minutes-with-help-from-a-few-d20s-8b78bfc890f7), and a [wide range of sessions](https://2018.srccon.org/schedule), with [tons of transcripts, notes, and resources documented](https://2018.srccon.org/documentation/).
